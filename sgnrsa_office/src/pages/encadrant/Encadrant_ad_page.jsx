...
export default function Encadrant_ad_page() {
      ...
      if (isValidate()) {
        ...
        dispacth(
          setToastAction({
            ...
            detail: "L'encadrant a été enregistré avec succès",
            life: 3000,
          })
        );
        navigate('/encadrant')
  ...
  useEffect(() => {
    dispacth(setBreadCrumbItemsAction([
      ...
      encadrant_routes_items.add_encadrant,
    ]))
    return () => {
      dispacth(setBreadCrumbItemsAction([]))
    }
          ...
          <div className="form-group col-sm mt-5">
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                ...
                <InputText
                  type="text"
                  placeholder="Ecrire le téléphone"
                  id="TEL"
                  name="TEL"
                  value={data.TEL}
                  onChange={handleChange}
