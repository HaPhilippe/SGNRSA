...
import Fonctionnalites from "../TabMenu/Fonctionnalites";
...
export default function Lot_production_list_page() {
  ...
  const ComfirmeDialogForCreateLotProduction = (e) => {
    ...
    confirmDialog({
      ...
      header: "Ajouter une faculte?",
      message: (
        <div className="d-flex flex-column align-items-center">
          <div className="text-center mt-5">
            Voulez-vous vraiment créer un la faculte?
          </div>
        </div>
      ),
      ...
      try {
        ...
        dispacth(
          setToastAction({
            ...
            detail: "Le département a été supprimé avec succès",
            life: 3000,
          })
        );
        fetchFaculte_departement();
    ...
    <>
      ...
      <div className="px-4 py-3 main_content">
        <div className="d-flex align-items-center justify-content-between">
          {/* <h1 className="mb-3">Faculté</h1><h1 className="mb-3">Faculté</h1> */}
          <Fonctionnalites/>
          <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="content">
          <div className="shadow rounded mt-3 pr-1 bg-white">
            ...
            >
              ...
              />
              <Column
                field="DESIGNATION_DEP"
                header="Description"
                sortable
                body={(item) => {
                  return (

                    <span>{item?.DESIGNATION_DEP
                    }</span>
                  ...
                  const items = [

                    {
                      template: (deleteItem, options) => {
                        return (
                          <Link
                            to={`/departements/edit/${inViewMenuItem?.ID_DEPARTEMENT}`}
